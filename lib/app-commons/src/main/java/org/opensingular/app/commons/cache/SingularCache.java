...
@Cacheable(cacheNames = SingularCache.SINGULAR_CACHE_NAME, unless = "T(org.opensingular.app.commons.cache.UnlessChecker).check(#result)", keyGenerator = SINGULAR_KEY_GENERATOR)
