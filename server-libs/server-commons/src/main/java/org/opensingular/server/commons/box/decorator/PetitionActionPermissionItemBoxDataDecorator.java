...
public class PetitionActionPermissionItemBoxDataDecorator implements ItemBoxDataDecorator {

    private final AuthorizationService authorizationService;

    @Inject
    public PetitionActionPermissionItemBoxDataDecorator(AuthorizationService authorizationService) {
