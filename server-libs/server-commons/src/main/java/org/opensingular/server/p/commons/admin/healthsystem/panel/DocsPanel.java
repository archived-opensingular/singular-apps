...
public class DocsPanel extends Panel implements Loggable {
    ...
    private void buildColumn(BSActionColumn<Class<? extends STypeComposite>, String> actionColumn) {
        actionColumn.appendAction($m.ofValue("Gerar Tabela"), DefaultIcons.MAGIC, (a,s) -> createTable(a, s, true, true));
        actionColumn.appendAction($m.ofValue("Gerar Tabela (SN)"), DefaultIcons.TRASH, (a,s) -> createTable(a, s, false, true));
        actionColumn.appendAction($m.ofValue("Gerar Tabela (SO)"), DefaultIcons.EXCLAMATION_TRIANGLE, (a,s) -> createTable(a, s, true, false));
        actionColumn.appendAction($m.ofValue("Gerar Tabela (SO&SN)"), DefaultIcons.ROCKET, (a,s) -> createTable(a, s, false, false));
    }

    private void createTable(AjaxRequestTarget ajaxRequestTarget, IModel<Class<? extends STypeComposite>> model, boolean showNumbers, boolean showObservacoes) {
