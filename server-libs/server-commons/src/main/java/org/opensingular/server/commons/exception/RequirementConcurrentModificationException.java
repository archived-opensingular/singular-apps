...
public class RequirementConcurrentModificationException extends SingularRequirementException {
    ...
    public RequirementConcurrentModificationException(String msg) {
        super(msg);
    }

    public RequirementConcurrentModificationException(Throwable cause) {
        super(cause);
    }

    public RequirementConcurrentModificationException(String msg, Throwable cause) {
        super(msg, cause);
    }
}
