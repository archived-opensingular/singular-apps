...
public class PetitionDAO<T extends PetitionEntity> extends BaseDAO<T, Long> {
    ...
    public PetitionAuthMetadataDTO findPetitionAuthMetadata(Long petitionId) {
        ...
        query.append(" select distinct new ").append(PetitionAuthMetadataDTO.class.getName()).append("(ftm.abbreviation, ftm.abbreviation, td.abbreviation, pd.key, ct.cod) from ");
