...
public class RequirementTransitionPanel extends Panel implements Loggable {
    ...
    private AjaxEventBehavior createInputEvent(Form form, IModel<String> idRequirement, Component dropDownChoice) {
        return new AjaxFormComponentUpdatingBehavior("blur") {
            ...
            protected void onError(AjaxRequestTarget target, RuntimeException e) {
                ...
                instance = null;
                dontFindRequerimentAction(target, dropDownChoice, form, idRequirement, false);
            }
        };
    }

    private void dontFindRequerimentAction(AjaxRequestTarget target, Component dropDownChoice, Form form, IModel<String> idRequirement, boolean showToast) {
    ...
    private void addSubmitButton(Form form) {
        submitButton = new AjaxButton("buttonSubmit") {
            @Override
            protected void onSubmit(AjaxRequestTarget target, Form<?> form) {
                super.onSubmit(target, form);

                if (instance != null) {
                    requirementService.forceStateUpdate(instance, getSTaskByName(requirementTask.getObject()));
