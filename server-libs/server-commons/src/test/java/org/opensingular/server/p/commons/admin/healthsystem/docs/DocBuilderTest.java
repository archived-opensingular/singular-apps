...
public class DocBuilderTest {
    ...
    public void buildTest() throws Exception {
        ...
        Assert.assertEquals("Complemento", saida.toArray(new DocTable[0])[2].getBlockList().toArray(new DocBlock[0])[0].getMetadataList().toArray(new DocFieldMetadata[0])[4].getFieldName());
        Assert.assertEquals("Bairro", saida.toArray(new DocTable[0])[2].getBlockList().toArray(new DocBlock[0])[0].getMetadataList().toArray(new DocFieldMetadata[0])[5].getFieldName());
        Assert.assertEquals("Cidade", saida.toArray(new DocTable[0])[2].getBlockList().toArray(new DocBlock[0])[0].getMetadataList().toArray(new DocFieldMetadata[0])[6].getFieldName());
        Assert.assertEquals("Estado", saida.toArray(new DocTable[0])[2].getBlockList().toArray(new DocBlock[0])[0].getMetadataList().toArray(new DocFieldMetadata[0])[7].getFieldName());
        Assert.assertEquals("País", saida.toArray(new DocTable[0])[2].getBlockList().toArray(new DocBlock[0])[0].getMetadataList().toArray(new DocFieldMetadata[0])[8].getFieldName());
    }
