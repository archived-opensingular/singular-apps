...
public class SingularServerDocumentFactory extends SpringSDocumentFactory {
    ...
    protected void setupDocument(SDocument document) {
        ServiceRegistryLocator.locate().lookupService(SDocument.FILE_TEMPORARY_SERVICE, IAttachmentPersistenceHandler.class)
        ...
        ServiceRegistryLocator.locate().lookupService(SDocument.FILE_PERSISTENCE_SERVICE, IAttachmentPersistenceHandler.class)
