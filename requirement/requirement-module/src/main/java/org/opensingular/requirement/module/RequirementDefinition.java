...
public abstract class RequirementDefinition<RI extends RequirementInstance> implements Loggable{
    ...
    protected RI newRequirementInstance(){
        try {
            return this.requirementInstanceClass.newInstance();
        } catch (Exception e) {
    ...
    public RI newRequirement() {
        return requirementService.createNewRequirementWithoutSave(this, newRequirementInstance(), null);
    }

    public RI newRequirement(RequirementInstance parent) {
        return requirementService.createNewRequirementWithoutSave(this, newRequirementInstance(), parent);
    }

    public RI loadRequirement(Long requirementId){
        return (RI) requirementService.getRequirement(requirementId);
    }
