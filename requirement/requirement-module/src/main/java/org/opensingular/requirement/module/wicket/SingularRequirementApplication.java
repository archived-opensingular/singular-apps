...
import org.opensingular.requirement.module.wicket.listener.SingularServerContextListenerSingular;
...
public abstract class SingularRequirementApplication extends AuthenticatedWebApplication
    ...
    public void init() {
        ...
        getRequestCycleListeners().add(new SingularServerContextListenerSingular());
