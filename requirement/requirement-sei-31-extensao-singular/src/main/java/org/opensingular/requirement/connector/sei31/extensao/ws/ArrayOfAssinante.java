...
/**
 * <p>Java class for ArrayOfAssinante complex type.
 * 
 ...
 *       &lt;sequence&gt;
 *         &lt;element name="Assinante" type="{extensaons}Assinante" maxOccurs="unbounded" minOccurs="0"/&gt;
 *       &lt;/sequence&gt;
 *     &lt;/restriction&gt;
 *   &lt;/complexContent&gt;
 * &lt;/complexType&gt;
...
@XmlType(name = "ArrayOfAssinante", propOrder = {
    "assinante"
})
public class ArrayOfAssinante {

    @XmlElement(name = "Assinante")
    protected List<Assinante> assinante;
    ...
    public List<Assinante> getAssinante() {
        if (assinante == null) {
            assinante = new ArrayList<Assinante>();
        }
