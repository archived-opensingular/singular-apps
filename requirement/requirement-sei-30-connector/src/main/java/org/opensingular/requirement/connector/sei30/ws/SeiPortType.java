...
public interface SeiPortType {
     ...
     * @param idMarcador
     * @return
     *     returns RetornoGeracaoProcedimento
     */
     ...
     * @param documento
     * @return
     *     returns RetornoInclusaoDocumento
     */
    @WebMethod(action = "SeiAction")
    @WebResult(name = "parametros", partName = "parametros")
     ...
     * @return
     *     returns RetornoConsultaDocumento
     */
    @WebMethod(action = "SeiAction")
    @WebResult(name = "parametros", partName = "parametros")
     ...
     * @param siglaSistema
     * @return
     *     returns ArrayOfArquivoExtensao
     */
    @WebMethod(action = "SeiAction")
    @WebResult(name = "parametros", partName = "parametros")
     ...
     * @param siglaSistema
     * @return
     *     returns ArrayOfTipoConferencia
     */
    @WebMethod(action = "SeiAction")
    @WebResult(name = "parametros", partName = "parametros")
     ...
     * @param protocoloProcedimento
     * @return
     *     returns ArrayOfAndamentoMarcador
     */
    @WebMethod(action = "SeiAction")
    @WebResult(name = "parametros", partName = "parametros")
